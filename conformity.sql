...
CREATE TABLE `clientes` (
  ...
  `telefone1` varchar(16) COLLATE utf8_unicode_ci NOT NULL,
  `telefone2` varchar(16) COLLATE utf8_unicode_ci NOT NULL
...
CREATE TABLE `inspecoes` (
  ...
  `armazem` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `inspetores`
--
...
CREATE TABLE `tarefas` (
  `id` int NOT NULL,
  `nivelUrgencia` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- AUTO_INCREMENT for table `inspecoes`
--
ALTER TABLE `inspecoes`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
